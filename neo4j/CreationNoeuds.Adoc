...
MERGE(positionPanama:Position{latitude:8.537981 ,longitude:-80.782127, lieu:'Panama', site:'San Felipe'})
// ----
...
MERGE(transaction14:Transaction{sens:'D',date:'2017-06-20',ibanDestinataire:'IBAN987654',ibanEmetteur:'IBAN345678',libelle:'autres',montant:260.00,ip:'177.10.4.1'})
MERGE(transaction15:Transaction{sens:'D',date:'2017-06-26',ibanDestinataire:'IBAN987654',ibanEmetteur:'IBAN345678',libelle:'parking',montant:450.00,ip:'177.10.4.1'})
MERGE(transaction16:Transaction{sens:'D',date:'2017-06-24',ibanDestinataire:'IBAN987654',ibanEmetteur:'IBAN345678',libelle:'autres',montant:600.00,ip:'177.10.4.1'})
MERGE(transaction17:Transaction{sens:'D',date:'2017-06-26',ibanDestinataire:'IBAN234567',ibanEmetteur:'IBAN345678',libelle:'achats bureautiques',montant:100.00,ip:'177.10.4.1'})
MERGE(transaction18:Transaction{sens:'D',date:'2017-06-26',ibanDestinataire:'IBAN234567',ibanEmetteur:'IBAN345678',libelle:'achats bureautiques',montant:100.00,ip:'177.10.4.1'})
MERGE(transaction19:Transaction{sens:'D',date:'2017-06-26',ibanDestinataire:'IBAN234567',ibanEmetteur:'IBAN345678',libelle:'achats bureautiques',montant:100.00,ip:'177.10.4.1'})
MERGE(transaction20:Transaction{sens:'D',date:'2017-06-26',ibanDestinataire:'IBAN234567',ibanEmetteur:'IBAN345678',libelle:'achats bureautiques',montant:100.00,ip:'177.10.4.1'})
// ----
